...
import com.amazonaws.restClient.DynamoDBRestClient;
import com.amazonaws.restClient.Member;
...
public class MainConsole {
    ...
    private static void CreateUser(CognitoHelper helper) {
        ...
        if (success) {
            ...
            //Insert in the Dynamo DB
             Member m=new Member();
             m.setName(username);
             m.setMobileNumber(phonenumber);
             m.setEmailId(email);
            DynamoDBRestClient.createMemberInfo(m);
        } else {
